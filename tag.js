    ...
    try {
        (function() {
            ...
            function yh(a, c, b) {
                ...
                if (e) try {
                    F(e, d)(mb(a, c))
                } catch (f) {} else zh = V(a, E([a, c, 2 * b], yh),
                    b, "ai.d");
                return function() {
                    return na(a, zh)
                }
            ...
            function mm(a, c) {
                ...
                if (!b.getShaderPrecisionFormat) return J("~", d); of (d, pm(b));
                return J("~", d)
            }
            ...
            function Ch(a,
                ...
                var d = n(c, "clientId"),
                    ...
                    f = n(c, "service_id"),
                    g = n(c, "phones") || [];
                return d && e && g ? vm(a, b.xc, {
                    Gg: wm
                }).fg(g).then(function(h) {
                    return xm(b, {
                        Pb: d,
                        $b: e,
                        wg: f
            ...
            function pm(a) {
                return M(function(c, b) {
                    ...
                    ["webgl fragment shader medium float", a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,
                        a.MEDIUM_FLOAT)],
            ...
            function Hm(a, c) {
                var b = a.document;
                if (K(b.readyState, ["interactive", "complete"])) Kb(a, c);
                else {
                    var d = ia(a),
                        e = d.D,
                        f = d.kc,
            ...
            function Im(a) {
                var c = D(a, "i.clch", Jm);
                ia(a).D(a.document, ["click"], F(c, null, a), {
                    passive: !1
                });
                return function(b) {
                    var d = sa.Za,
            ...
            function bn(a, c, b) {
                ...
                e = e.D(a, ["message"], function(r) {
                    var v = tb(a, r.data);
                    v && v.type && K(v.type, cn) && d.O(v.type, {
                        data: v,
                        source: r.source,
                        origin: r.origin
                    })
            ...
            function ge(a, c, b, d, e, f) {
                ...
                if (Af(c)) "value" === b ? !ma(d) && "" !== d && (b = e.ae, f = e.dg, e = jd(a, c), f ? (b = Jc(a, c, b), a = b.wb, c = b.pb, b = b.cb, g.vb = !c && (e || a)) : (g.vb = e, b = !(c && $b("ym-record-keys", c))), b || e) && (g.value = J("", A(u("\u2022", O), ("" + d).split("")))) : "checked" === b && K((c.getAttribute("type") ||
                    "").toLowerCase(), gn) ? g.value = c.checked ? "checked" : null : hn.test(b) && Bf(a, c) && (g.value = null);
                else if ("IMG" === f && "src" === b)(e = jd(a, c)) ? (g.vb = e, g.value = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=") : g.value = (c.getAttribute("srcset") ? c.currentSrc : "") || c.src;
                else if ("A" === f && "href" === b) g.value = d ? "#" : "";
                else if (K(b, ["srcset", "integrity", "crossorigin", "password"]) || 2 < b.length && 0 === he(b, "on") || "IFRAME" === f && "src" === b || "SCRIPT" === f && K(b, ["src", "type"])) g.value = null;
                return g
            }
            ...
            function Jc(a, c, b) {
                ...
                var e = Z(Xh, [c.className, c.id, c.name]),
                    f = c && $b("ym-record-keys", c);
                d = d && K(d, Yh) || Ja(Ya(sn),
                    e);
                var g;
            ...
            function ke(a, c, b) {
                ...
                return jc(a, function(e, f) {
                    ...
                    var l = g >> 3;
                    if (g & 1) tc(d, nb(l)), h = k(h), l & 2 && tc(d, nb(h[1])), tc(d, h);
                    else if (g & 4)
            ...
            function vo(a, c, b, d) {
                ...
                else if (3.4028234663852886E38 < c) nd((e << 31 | 2139095040) >>>
                    0, b, d);
            ...
            function li(a, c, b) {
                return function(d, e, f) {
                    ...
                    f = {
                        ...
                        Y: y(d.Y, {
                            Cb: (g = {}, g["Content-Type"] = "text/plain", g),
                            Ze: "POST"
                        }),
                        G: h
                    };
            ...
            function zo(a, c, b) {
                ...
                return {
                    ...
                    C: function(g, h) {
                        ...
                        }, [sa.Za + "//" + bc + "/user_storage_set"], {})["catch"](D(a, "u.d.s.s"))
                    }
                }
            }
            ...
            function gp(a, c) {
                function b() {
                    q.hidden ? y(k.style, td(["top", "right", "left", "background"], "initial")) : y(k.style, td(["top", "right", "left"], "0"), {
                        ...
                        return new I(function(l, m) {
                            ...
                            cc(a)(Sa(u({
                                ...
                                var p = fa(a),
                                    ...
                                    v = g.text ? Hi(a, h) : [];
                                l({
                                    qa: Z(ca, Z(Boolean, A(d, r.concat(v)))),
                                    Ba: p(aa) -
                                        q
                                })
                            }))
            ...
            function wf(a, c, b, d, e) {
                ...
                void 0 === e && (e = -1);
                if (T(b) && f(c) === a.NodeFilter.FILTER_ACCEPT && (b(c), !If(c)))
            ...
            function up(a, c) {
                var b = {};
                z(function(d) {
                    var e = a[d] || Yf[d] || d; - 1 !== d.indexOf("item_category") ?
            ...
            function ve(a, c, b) {
                ...
                ib(a, {
                    ...
                    data: {
                        Eb: "Link click",
                        name: (b.ub ? "external" : "internal") + " url: " + b.url
                    }
                });
            ...
            function Mp(a, c, b, d, e) {
                return (new I(function(f, g) {
                    var h = da(b),
                        k = t(d.resolve ? d.resolve : O, gd(f)),
                        l = t(d.reject ? d.reject : O, gd(g));
                    d.resolve = k;
                    d.reject = l;
                    z(function(m) {
                        var p;
            ...
            function fj(a, c) {
                return new I(function(b, d) {
                    ...
                    a.crypto.subtle.digest("SHA-256", e).then(function(f) {
                        ...
                        g.onload = function(h) {
                            h = n(h, "target.result");
                            var k = (h || "").indexOf(","); - 1 !== k ? b(h.substring(k + 1)) : d(ic("fpm.i"))
                        };
                        g.readAsDataURL(f)
                    }, d)
                })
            ...
            function Xp(a, c, b) {
                return new I(function(d, e) {
                    var f, g, h = "_ymjsp" + Va(a),
                        k = y((f = {}, f.callback = h, f), b.bc),
                        l = E([a, h], Zp);
                    a[h] = function(p) {
                        try {
                            l(), nc(m), d(p)
            ...
            function cq(a, c, b, d, e, f, g, h) {
                if (4 === c.readyState)
                    if (200 === c.status || e || g(b), e) 200 === c.status ? f(c.responseText) : g(ic("http." + c.status + ".st." + c.statusText + ".rt." + ("" + c.responseText).substring(0, 50)));
                    else {
                        e = null;
                        if (d) try {
            ...
            function lq(a, c) {
                return function(b, d) {
                    ...
                    var g = (e = {
                        data: d
                    }, e.__yminfo = J(":", ["__yminfo", f.Bc, f.key, f.dir]), e);
                    return {
                        aa: f,
                        Ag: mb(a, g) || ""
                    }
            ...
            function Fc(a, c) {
                ...
                var m = !1;
                !h && k && (h = k, m = !0);
                if (!h) h = J("", [g, Va(a, 1E6, 999999999)]), m = !0;
            ...
            function jk(a, c) {
                ...
                0 === a.Na ? a.Lb.push(c) : (a.af = !0, Fa.bf(function() {
                    ...
                    if (null === b)(1 === a.Na ? Jg : Od)(c.gb, a.Xa);
                    else {
                        try {
                            var d = b(a.Xa)
                        } catch (e) {
            ...
            function tk(a) {
                ...
                if (Df(b)) {
                    ...
                    else g = b.value, g = f ? J("", uk(g.split(""))) : g;
                    c = rc(c, b);
                    f = ub(a.l);
                    d = d && !e;
                    e = [];
            ...
            var Sc = {
                ...
                zk = Ma(Function.prototype.bind, "bind"),
                F = zk ? function() {
                    var a = Ca(arguments);
                ...
                Oc = la(E),
                Bi = la(qa),
                Ak = Ma(Array.prototype.reduce, "reduce"),
                M = Ak ? function(a, c, b) {
                ...
                Bk = Ma(Array.prototype.filter, "filter"),
                Z = Bk ? function(a, c) {
                    return Bk.call(c, a)
                } : dk,
                Na = u(Boolean, Z),
                Rg = la(Z),
                bb = Aa("find", Array.prototype.find) ? function(a, c) {
                ...
                uc = Ib(K),
                Ck = Ma(Array.prototype.join, "join"),
                J = Ck ? function(a, c) {
                    return Ck.call(c, a)
                } : Xq,
                qd = la(J),
                Dk = x(function(a) {
                    ...
                    return {
                        Nf: -1 <
                            (n(a, "vendor") || "").indexOf("Apple"),
                        Mg: c
                    }
                }),
                gb = x(X("navigator.userAgent")),
                Cg = /Firefox\/([0-9]+)/i,
                Kd = x(function(a) {
                ...
                Md, Wq = t(Dg, ka("[object Array]")),
                Ek = Ma(Array.prototype.map, "map"),
                A = Ek && Vq(window, Array.prototype.map) ? function(a, c) {
                    return c && 0 < c.length ? Ek.call(c, a) : []
                } : ck,
                z = A,
                mc = Array.prototype.flatMap ?
                function(a, c) {
                ...
                xc = X("0"),
                Ar = la(Eg),
                Fk = Ma(Array.prototype.reverse, "reverse"),
                rr = Fk ? function(a) {
                    return Fk.call(a)
                } : Tq,
                Gk = Ib(parseInt),
                ...
                da = Object.keys ? Object.keys : ak,
                Br = t(Zj,
                    u(X("1"), ck)),
                Cr = Object.values ? Object.values : Br,
                y = Object.assign || Sq,
                Uh = la(function(a, c) {
                    return y({}, a, c)
                }),
                bd = x(t(X("String.fromCharCode"), u("fromCharCode", Aa), Tb)),
                Ne = x(t(gb, Ya(/ipad|iphone|ipod/i))),
                Qf = x(function(a) {
                ...
                Hr = "other none unknown wifi ethernet bluetooth cellular wimax mixed".split(" "),
                Ir = x(function(a) {
                ...
                sg = x(t(X("document.addEventListener"), Tb)),
                Hk = x(function(a) {
                    var c = n(a, "navigator") || {};
                    return M(function(b, d) {
                        return b || n(c, d)
            ...
            var I = window.Promise,
                Qr = Ma(I, "Promise"),
                Ik = Ma(n(I, "resolve"), "resolve"),
                Jk = Ma(n(I, "reject"), "reject"),
                Kk = Ma(n(I, "all"), "all");
            if (K(!1, [Qr, Ik, Jk, Kk])) I = Fa;
            else {
                var Ve = function(a) {
            ...
            var Wj = uc([26812653]),
                ...
                Rd, ic = function(a) {
                    return function(c, b) {
                        ...
                        else Aa("Error", a.Error) ? (Rd = a.Error, d = new a.Error(c)) : (Rd = Nq, d = new Rd(c));
                        b && (d.unk = !0);
                        return d
                    }
                }(window),
            ...
            var Fb = E([1, null], Pe),
                ...
                Zr = ka("SELECT"),
                vq = t(Ia, Zr),
                Ie = t(X("type"), Ya(/^(checkbox|radio)$/)),
                Df = t(Ia, Ya(/^INPUT|SELECT|TEXTAREA$/)),
                ...
                mj = /^\s+|\s+$/g,
                Bj = Ma(String.prototype.trim, "trim"),
                Ok = la(function(a, c) {
                    return c.replace(a, "")
                }),
                Fi = Ok(/\s/g),
            ...
            var Vc, og = "button," + A(function(a) {
                ...
                Pk = t(S, X("protocol"), ka("https:")),
                Qk = /\/$/,
                as = x(t(fa, za(function(a) {
                ...
                Xg = X("postMessage"),
                es = C("s.f", function(a, c, b, d, e) {
                    c = c(d);
                    var f = Hd(a),
                        g = J(":", [c.aa.Bc, c.aa.key]);
                    if (Xg(b)) {
                        f.pending[g] = e;
                        try {
                            b.postMessage(c.Ag, "*")
                ...
                fs = C("s.fh", function(a, c, b, d, e, f) {
                    ...
                    if (!ma(h) && h.substring && "__yminfo" === h.substring(0, 8) && !ma(l) && (g = h.split(":"), 4 === g.length))
                        if (h = c.id, c = g[1], a = g[2], g = g[3], !ca(l) && l.type && "0" === g && l.counterId) {
                            if (!l.toCounter || l.toCounter == h) {
                                k = null;
                                try {
                                    k = f.source
                                } catch (m) {}!Ua(k) && Xg(k) && (f = d.O(l.type, [f, l]), e = A(t(O, Uh(e)), f.concat([{}])), l = b([c, a, l.counterId], e),
                                    k.postMessage(l.Ag, "*"))
                            }
                ...
                cd = x(function(a, c) {
                    var b, d = ec("getElementsByTagName", n(a, "document")),
                        e = Hd(a),
                        f = Xg(a),
                        g = id(a),
                        h = ia(a);
            ...
            var hs =
                ...
                ah, is = F(I.reject, I, Ta()),
                Ea = (ah = {}, ah.h = kb, ah),
                Ba = C("g.sen", function(a, c, b) {
                    var d = ed(a, c);
                    b = b ? dq(a, c, b) : [];
                    var e = Ea[c],
                ...
                cj = x(vd),
                Cd = x(Ac, N),
                ps = C("pa.int", function(a, c) {
                    var b;
                    return b = {}, b.params = function() {
                        var d, e, f = Ca(arguments),
                            g = Op(f);
                        if (!g) return null;
                        f = g.Ah;
                        var h = g.ea;
                ...
                te = C("go.in", function(a, c, b, d) {
                    ...
                    return e = {}, e.reachGoal = function(f, g, h, k) {
                        ...
                        T(g) && (q = g, p = void 0,
                            k = h);
                        var r = Gb(a, c, "Reach goal. Counter: " + c.id + ". Goal id: " + f, p),
                            v = "goal" === b;
                        g = Ba(a, "g", c);
                        var w = Jp(a, c, f, b);
                        h = w[0];
                ...
                xs = C("nb.p", function(a, c) {
                    ...
                    function d(G) {
                        return function(Y) {
                            ...
                            if (G || !r && !k.$d) {
                                ...
                                oa = Cd(c);
                                oa = {
                                    G: (ta = {}, ta["page-url"] = oa.url || S(a).href, ta),
                                    H: vb,
                                    V: {
                                        force: G
                                    }
                    ...
                    var e, f, g = Ba(a, "n", c),
                        ...
                        m = u((e = {}, e.accurateTrackBounce = !0, e), ze(a, h)),
                        p = fa(a),
                        q = p(aa),
                        r = !1,
                        v = 0,
                ...
                Cp = la($b)("(ym-disable-clickmap|ym-clickmap-ignore)"),
                ys = C("clm.p",
                    function(a, c) {
                        if (bd(a)) return B;
                        var b = Ba(a, "m", c),
                ...
                Vb, Td, ch, Bc, Yf = (Vb = {}, Vb.transaction_id = "id", Vb.item_brand = "brand", Vb.index = "position", Vb.item_variant = "variant", Vb.value = "revenue", Vb.item_category = "category", Vb.item_list_name = "list", Vb),
                ...
                bl = Ma(String.prototype.repeat, "repeat"),
                Xs = bl ? function(a, c) {
                    return bl.call(a, c)
                } : bp,
                ...
                el = sa.Za + "//" + bc + "/metrika",
                fl = el + "/metrika_match.html",
                sb, db, Tl = (sb = {}, sb.am = "com.am", sb.tr = "com.tr", sb.ge = "com.ge", sb.il = "co.il", sb["\u0440\u0444"] = "ru", sb["xn--p1ai"] = "ru", sb["\u0443\u043a\u0440"] = "ua", sb["xn--j1amh"] = "ua", sb["\u0431\u0435\u043b"] = "by", sb["xn--90ais"] = "by", sb),
                gl = {
                ...
                No = "ar:1:pv:1:v:" + sa.jb + ":vf:" + Sc.version,
                Oo = sa.Za + "//" + bc + "/watch/" + sa.Tg,
                hl = {},
                ...
                $e, Ko = ($e = {}, $e.s = "p", $e["8"] = "i", $e),
                Ho = pb("csp", function(a, c) {
                    return Ba(a, "s", c)({}, ["https://ymetrica1.com/watch/3/1"])
                }),
                eh = "et w v z i u vf".split(" "),
                wo = {
                    L: "stamp",
                    M: "frameId",
                    aa: "meta",
                ...
                Ud, fh = (Ud = {}, Ud[1] = 500, Ud[2] = 500, Ud[3] = 0, Ud),
                gh = function() {
                    function a(c, b) {
                        var d, e = this;
                        this.id = "a";
                ...
                jl = function(a) {
                    ...
                    c.prototype.Ga = function(b) {
                        ...
                        return g ? (b = mc(u(g, n), ["acceptedAnswer", "suggestedAnswer"]), A(function(h) {
                            ...
                            return a.prototype.Ga.call(d, h)
                        }, b)) : K(b.data["@type"], this.Fb["schema.org"]) ? a.prototype.Ga.call(this, y(b, {
                            type: this.ve(b.data)
                        })) : null
                    };
                ...
                kl = function(a) {
                    ...
                    c.prototype.ai = function(b) {
                        ...
                        return K(f.type, this.Fb.Zf) ? y(b, {
                            data: f
                        }) : null
                    };
                    c.prototype.Pa = function(b) {
            ...
            var nt = C("p.p", function(a, c) {
                ...
                tn = new RegExp("(" + J("|", ml) + ")", "i"),
                sn = new RegExp("(" + J("|", Yh) + ")", "i"),
                ...
                on = /^\s*function submit\(\)/,
                tt = C("fw.p", function(a, c) {
                    var b;
                    if (!(b = c.Dh || !c.Kb)) {
                        var d = H(a),
                            e = !1;
                ...
                ih, ol = (ih = function(a) {
                    ...
                    c.prototype.Bj = function(b, d) {
                        var e = this;
                        na(this.l, this.nf);
                        var f = Math.ceil(this.ra.$a(d) / 63E4),
                            g = this.ra.kd(d, f);
                        z(function(h, k) {
                            var l, m = y({}, b,
                ...
                ut = function(a) {
                    ...
                    c.prototype.sd = function(b) {
                        var d = b.target;
                        b = b.attributeName;
                        var e = this.ua.elements.indexOf(d); - 1 === e && (e = this.ua.elements.push(d) - 1, this.ua.attributes[e] = {});
                ...
                vt = function() {
                    function a(c, b) {
                        ...
                        this.removeNode = function(f) {
                            var g = d.$(f),
                                h = Ia(f);
                            if (h) return h = "NR:" + h.toLowerCase(), d.Vd(h) && d.ca.O(h, {
                                data: {
                                    node: f,
                                    id: g
                                }
                    ...
                    a.prototype.Mc = function(c) {
                        ...
                        z(function(g) {
                            Mi(b.l, g, function(h) {
                                var k = b.sb(h);
                                Ua(k) || (d.push(h), b.yb[k] && b.$(h), b.yb[k] = {
                                    node: h,
                                    event: f,
                                    Pj: e
                                }, e += 1)
                            ...
                            if (W(r)) c = void 0;
                                ...
                                if (If(c)) {
                                    if (h = dn(c, h), g.attributes = {}, g.content = h)
                                        if (c = jd(m, c)) g.content = "" !== h.trim() ? wn(m, h) : h, g.hidden = c
                ...
                wt = ["input", "change", "keyup", "paste", "cut"],
                xt = function(a) {
                    function c(b, d, e) {
                        b = a.call(this, b, d, e) || this;
                        b.inputs = {};
                ...
                zt = function(a) {
                    ...
                    c.prototype.ij = function(b) {
                        if (this.F.rb().Mf()) this.ad(b);
                        else {
                            var d = b.target,
                                e = Z(function(f) {
                                    return f[0] === d
                                }, this.Dg).pop();
                            e ? e = e[1] : (e = this.Da.zc(F(this.ad, this), 100, {
                                ob: !0
                            }), this.Dg.push([d, e]));
                            e(b)
                        }
                ...
                At = ["mousemove", "mousedown", "mouseup", "click"],
                Bt = function(a) {
                    function c(b, d, e) {
                        d = a.call(this, b, d, e) || this;
                        d.ma.push([At, d.ej]);
                ...
                Dt = function(a) {
                    ...
                    c.prototype.Sh = function(b) {
                        ...
                        b = b.type;
                        this.F.X("event", {
                            target: this.$(d === this.l ? this.l.document.documentElement : d)
                        }, b)
                    };
                    return c
                }($a),
                ...
                Ft = t(Et, ha),
                Gt = ["mousemove", "touchmove", "mousedown", "touchdown", "select"],
                Ht = /text|search|password|tel|url/,
                It = function(a) {
                    function c(b, d, e) {
                        b = a.call(this, b, d, e) || this;
                        b.Wd = !1;
                    ...
                    c.prototype.ji = function() {
                        ...
                        if (b && 0 < b.rangeCount) {
                            ...
                            var d = this.$(b.startContainer),
                                e = this.$(b.endContainer);
                            if (!W(d) && !W(e)) return {
                                start: b.startOffset,
                                end: b.endOffset,
                                yg: d,
                ...
                Kt = function(a) {
                    ...
                    c.prototype.handleEvent = function(b) {
                        this.F.X("event", {}, Jt[this.visibility ? this.l.document[this.visibility.hidden] ? "blur" : "focus" : b.type])
                    };
                    return c
                }($a),
                Lt = ["touchmove", "touchstart", "touchend", "touchcancel", "touchforcechange"],
                Mt = function(a) {
                    function c(b, d, e) {
                        d = a.call(this, b, d, e) || this;
                        d.md = {};
                        ...
                        d.Da = new bf(b);
                        d.Yb = d.K.J(d.Yb, "nh");
                        d.Ij = d.K.J(d.Da.zc(d.Yb, d.F.rb().Mf() ? 0 : 50, {
                            ob: !0
                        }), "th");
                        return d
                    }
                ...
                Xt = ["addRule", "removeRule", "insertRule", "deleteRule"],
                kh = [
                    [function(a) {
                        function c(b, d, e) {
                            b = a.call(this, b, d, e) || this;
            ...
            var Yt = x(function(a) {
                ...
                au = function() {
                    function a(c) {
                        ...
                        this.sf = [];
                        this.l = c;
                        this.Xb = (b = {}, b.event = F(this.Hh, this), b.page = lh({
                            page: 1
                        }), b.mutation = lh({
                            Vi: 1
                        }), b.activity = lh({
                ...
                rl = x(function(a) {
                    ...
                    if (W(b)) {
                        ...
                        else if (a = Ra(a).o("wasSynced"), a = n(a, "params.eu")) c.C("isEU", a), b = !!a
                    }
                    return b
                }, function(a) {
                    return H(a).o("isEU")
                ...
                du = C("w2", function(a, c) {
                    ...
                    Eq([g, f])(Sa(D(a, "wv2.R.c"), function(k) {
                        ...
                        if (!h) {
                            ...
                            if (!Sh(a, k) || m) b();
                            else if (ia(a).D(a, ["beforeunload", "unload"], b), d.C("wv2Counter", e), d.C("stopRecorder", b), k = [new af(a)], k.unshift(new au(a)), k = bb(function(v) {
                                    return v.isEnabled()
                                }, k)) {
                                m = new bu(a, c, !(k instanceof af), 0);
                                var p = ol.Bf(e, "m", F(m.Wi, m), k, a),
                                    q = ol.Bf(e, "e", F(m.Ih, m), k, a);
                                k = Ym();
                                m = k.bj;
                                q.D("ag", k.fh);
                                q.D("p", m);
                ...
                eu = C("w2.cs", function(a, c) {
                    var b, d = N(c);
                    bg(a, d, (b = {}, b.webvisor = !!c.Kb, b))
                }),
                sl = x(Ac, N),
                Oh = t(dd, oc),
                tl = B,
                fu = pb("isp.stat", function(a, c) {
                    return new I(function(b, d) {
                        if (rq(a, fl, "isp")) {
                            var e = function(f) {
                                ("1" === f ? b : d)();
                ...
                Yc, Ab, Zc, mh = (Yc = {}, Yc.add_to_wishlist = "add-to-wishlist", Yc.begin_checkout = "begin-checkout", Yc.generate_lead = "submit-lead", Yc.add_payment_info = "add-payment-info",
                    Yc),
                ...
                Eu = ["webgl", "experimental-webgl"],
                Em = [-.2, -.9, 0, .4, -.26, 0, 0, .732134444, 0],
                rf = u(Ta("ccf"), Xa),
                ...
                Bm = "theora vorbis 1 avc1.4D401E mp4a.40.2 vp8.0 mp4a.40.5".split(" "),
                vm = x(Ai),
                Dh = x(tb, yb),
                Fu = C("phc.p", function(a, c) {
                    return Yk(a) ? B : ra(c, function(b) {
                        ...
                        e && f && b.length && (f = {
                            ...
                            Pf: !0
                        }), Ch(a, d, f), b = wd(a), e = Ci(a, b, 1E3), d = F(Ch, null, a, d, f), e.D(d), Di(a, b))
                    })
                }),
                oh = x(function(a, c) {
                    var b = H(a),
                ...
                km = ["name", "lang", "localService", "voiceURI", "default"],
                Iu = C("p.tfs", function(a) {
                    var c =
                        H(a);
                    if (!c.o("tfs")) {
                        c.C("tfs", !0);
                        ...
                        b = c.D(a, ["message"], function(d) {
                            ...
                            if (e && "https://iframe-toloka.com" === e && (d = tb(a, d.data), La(d) && "appendremote" === d.action))
                                if (d = Ra(a), d.o("tfsc") || a.confirm("\u0414\u043e\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u0435 \u201c\u0420\u0430\u0437\u043c\u0435\u0442\u043a\u0430 \u0441\u0430\u0439\u0442\u043e\u0432\u201c \u043e\u0442 toloka.ai \u0437\u0430\u043f\u0440\u0430\u0448\u0438\u0432\u0430\u0435\u0442 \u0434\u043e\u0441\u0442\u0443\u043f \u043a \u0441\u043e\u0434\u0435\u0440\u0436\u0438\u043c\u043e\u043c\u0443 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b. \u0420\u0430\u0437\u0440\u0435\u0448\u0438\u0442\u044c?")) {
                                    d.C("tfsc",
                                        1);
                                    var f, g;
                ...
                lf = t(hb(X("ymetrikaEvent.type")), Rg(uc(ae))),
                hm = {
                    url: "https://yastatic.net/s3/gdpr/popup/v2/",
                    Sf: "ru en et fi lt lv pl fr no sr".split(" "),
                    ag: "_two_main_buttons"
                },
                Wb, gm = (Wb = {}, Wb["GDPR-ok"] = "ok", Wb["GDPR-ok-view-default"] = "ok-default", Wb["GDPR-ok-view-detailed"] = "ok-detailed", Wb["GDPR-ok-view-detailed-0"] = "ok-detailed-all", Wb["GDPR-ok-view-detailed-1"] = "ok-detailed-tech", Wb["GDPR-ok-view-detailed-2"] = "ok-detailed-tech-analytics", Wb["GDPR-ok-view-detailed-3"] = "ok-detailed-tech-other", Wb),
                ce = [],
                uh =
                t(lf, hb(zr(ae)), qd(",")),
                vh = t(Rg(uc(ae)), Pa, Boolean),
                Zl = x(function(a, c) {
                    var b = c.o("gdpr");
                    return K(b, Xb) ? "-" + b : ""
                }),
                ...
                Su = pb("is", function(a) {
                    var c = ac(a);
                    if (Ae(a, "0")) c.Rb("debug_build");
                    else {
                        var b = Ae(a, "2"),
                            d = c.o("debug_build") === sa.jb;
                        if (b || d) return c.C("debug_build", sa.jb), lc(a, {
                            src: el + "/tag_debug.js"
                        })
                    }
                });
            ...
            var Bl = x(vd),
                ...
                Bb, Ml = (Bb = {}, Bb.brands = "chu", Bb.architecture = "cha", Bb.bitness = "chb", Bb.uaFullVersion = "chf",
            ...
            Xd.push(function(a, c) {
                ...
                if (!b.ke.$d) {
                    ...
                    if (e && 30 > d - e) b = b.da, delete H(a).o("counters", {})[b], Xa(Ta("uws"));
                    else ra(c, it(b))["catch"](D(a, "d.f"))
                }
            });
            (function() {
                var a,
            ...
            Ea.p = function(a, c, b) {
                return function(d, e) {
                    ...
                    h = {
                        ...
                        Y: y(g.Y, {
                            Cb: (f = {}, f["Content-Type"] = "text/plain", f),
                            Ze: "POST"
                        }),
                        G: h
                    };
